...
def build_weather_station_name_list():
    ...
    """
    station_names = []
    with open('internal/data/weather_stations.csv', 'r') as file:
...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    try:
        with open("internal/data/measurements.txt", 'w') as file:
    ...
    file_size = os.path.getsize("internal/data/measurements.txt")
